---
title: Nota Técnica da Rotina de Cálculo do Índice de Desenvolvimento Familiar (IDF) \vspace{25px}
author: |
 | \textit{Núcleo de Avaliação e Gestão da Informação} 
 | \textit{Vitória Sesana} \vspace{375px}
date: \textit{Janeiro de 2023}
output: 
  pdf_document:
    toc: true
