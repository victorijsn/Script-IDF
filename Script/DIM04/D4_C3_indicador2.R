...
# Indicador: 4.3.2. Renda familiar per capita superior a linha da pobreza


D4_C3_I2 <- function(base, linha_pobreza, ano_inicial, data_referencia){
  ...
  dado[, d4_c3_i2 := fcase(renda_media > linha_pobreza &
