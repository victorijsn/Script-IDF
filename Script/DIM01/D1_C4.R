...
D1_C4 <- function(base, com_comp=F) {
  ...
  source("Script/DIM01/D1_C4_indicador1.R",
         encoding = "UTF-8")
  source("Script/DIM01/D1_C4_indicador2.R",
         encoding = "UTF-8")
  source("Script/DIM01/D1_C4_indicador3.R",
         encoding = "UTF-8")
  
  
  # calculando os indicadores e definindo chave primária --------------------
  
  dado1 <- D1_C4_I1(dado); setkey(dado1, d.cod_familiar_fam)
  dado2 <- D1_C4_I2(dado); setkey(dado2, d.cod_familiar_fam)
  dado3 <- D1_C4_I3(dado); setkey(dado3, d.cod_familiar_fam)
