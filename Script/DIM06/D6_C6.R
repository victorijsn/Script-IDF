...
D6_C6 <- function(base, com_comp=F){
  ...
  source("Script/DIM06/D6_C6_indicador1.R",
         encoding = "UTF-8")
  # função indicador 6.6.2 
  source("Script/DIM06/D6_C6_indicador2.R",
         encoding = "UTF-8")
  
  dado1 <- D6_C6_I1(dado); setkey(dado1, d.cod_familiar_fam) # indicador 6.6.1
  dado2 <- D6_C6_I2(dado); setkey(dado2, d.cod_familiar_fam) # indicador 6.6.2
  ...
  dado[, d6_c6 := rowMeans(as.data.table(.(d6_c6_i1,
                                           d6_c6_i2)), 
                           na.rm = TRUE )]
